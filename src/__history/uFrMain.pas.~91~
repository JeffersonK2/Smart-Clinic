...
procedure TfrmMain.Image15MouseEnter(Sender: TObject);
begin
...
procedure TfrmMain.Panel12MouseEnter(Sender: TObject);
begin
if not(Sender is TPanel) then
    exit;
...
procedure TfrmMain.Panel12MouseLeave(Sender: TObject);
begin
if not(Sender is TPanel) then
    exit;
  (Sender as TPanel).ParentColor := true;
...
procedure TfrmMain.Panel17MouseEnter(Sender: TObject);
begin
if not(Sender is TPanel) then
    exit;
  (Sender as TPanel).color := RGB(43, 162, 182);
...
procedure TfrmMain.Panel17MouseLeave(Sender: TObject);
begin
if not(Sender is TPanel) then
    exit;
  (Sender as TPanel).ParentColor := true;
...
procedure TfrmMain.Panel18MouseEnter(Sender: TObject);
begin
if not(Sender is TPanel) then
    exit;
  (Sender as TPanel).color := RGB(43, 162, 182);
...
procedure TfrmMain.Panel18MouseLeave(Sender: TObject);
begin
if not(Sender is TPanel) then
    exit;
  (Sender as TPanel).ParentColor := true;
...
procedure TfrmMain.Panel19MouseEnter(Sender: TObject);
begin
if not(Sender is TPanel) then
    exit;
  (Sender as TPanel).color := RGB(43, 162, 182);
...
procedure TfrmMain.Panel19MouseLeave(Sender: TObject);
begin
if not(Sender is TPanel) then
    exit;
  (Sender as TPanel).ParentColor := true;
...
procedure TfrmMain.Panel1MouseLeave(Sender: TObject);
begin
if not(Sender is TPanel) then
    exit;
  (Sender as TPanel).ParentColor := true;
...
procedure TfrmMain.Panel21MouseEnter(Sender: TObject);
begin
if not(Sender is TPanel) then
    exit;
  (Sender as TPanel).color := RGB(43, 162, 182);
...
procedure TfrmMain.Panel21MouseLeave(Sender: TObject);
begin
if not(Sender is TPanel) then
    exit;
  (Sender as TPanel).ParentColor := true;
...
procedure TfrmMain.Panel3MouseEnter(Sender: TObject);
begin
if not(Sender is TPanel) then
    exit;
  (Sender as TPanel).color := RGB(43, 162, 182);
...
procedure TfrmMain.Panel3MouseLeave(Sender: TObject);
begin
if not(Sender is TPanel) then
    exit;
  (Sender as TPanel).ParentColor := true;
...
procedure TfrmMain.Panel5MouseEnter(Sender: TObject);
begin
if not(Sender is TPanel) then
    exit;
  (Sender as TPanel).color := RGB(43, 162, 182);
...
procedure TfrmMain.Panel5MouseLeave(Sender: TObject);
begin
if not(Sender is TPanel) then
    exit;
  (Sender as TPanel).ParentColor := true;
...
procedure TfrmMain.pCadastroMouseEnter(Sender: TObject);
begin
if not(Sender is TPanel) then
    exit;
  (Sender as TPanel).color := RGB(43, 162, 182);
...
procedure TfrmMain.pCadastroMouseLeave(Sender: TObject);
begin
if not(Sender is TPanel) then
    exit;
  (Sender as TPanel).ParentColor := true;
...
procedure TfrmMain.pConfMouseEnter(Sender: TObject);
begin
    if not(Sender is TPanel) then
    exit;
  (Sender as TPanel).color := RGB(43, 162, 182);
...
procedure TfrmMain.pConfMouseLeave(Sender: TObject);
begin
if not(Sender is TPanel) then
    exit;
  (Sender as TPanel).ParentColor := true;
...
procedure TfrmMain.pMovimMouseEnter(Sender: TObject);
begin
    if not(Sender is TPanel) then
    exit;
  (Sender as TPanel).color := RGB(43, 162, 182);
...
procedure TfrmMain.pMovimMouseLeave(Sender: TObject);
begin
if not(Sender is TPanel) then
    exit;
  (Sender as TPanel).ParentColor := true;
...
procedure TfrmMain.pRelatMouseEnter(Sender: TObject);
begin
if not(Sender is TPanel) then
    exit;
  (Sender as TPanel).color := RGB(43, 162, 182);
...
procedure TfrmMain.pRelatMouseLeave(Sender: TObject);
begin
    if not(Sender is TPanel) then
    exit;
  (Sender as TPanel).ParentColor := true;
...
procedure TfrmMain.pSairMouseEnter(Sender: TObject);
begin
  if not(Sender is TPanel) then
    exit;
  (Sender as TPanel).color := RGB(43, 162, 182);
...
procedure TfrmMain.pSairMouseLeave(Sender: TObject);
begin
if not(Sender is TPanel) then
    exit;
  (Sender as TPanel).ParentColor := true;
